...
import { categories } from '../../constants/agro';
import { useMultipleCarousels } from '../../hooks/useMultipleCarousels';
import { anclajesStyles } from '../../styles/anclajes.styles';

const FILTER_CATEGORIES = [
  { id: '11.01', label: '11.01 Alimentación y complementos' },
  { id: '11.02', label: '11.02 Ordeño' },
  { id: '11.03', label: '11.03 Higiene' },
  { id: '11.04 ', label:'11.04 Manejo ganadero'}
];
