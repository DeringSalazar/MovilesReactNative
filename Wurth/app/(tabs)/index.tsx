...
interface Category {
  title: string;
  image: any;
  href?: '/grupo-fer/auto' | '/grupo-fer/anclajes' | '/grupo-iby/electricidad' | '/grupo-iby/herramientas' | '/grupo-alvaro/seguridad' | '/grupo-alvaro/maquinas' | '/grupo-erik/quimicos' | '/grupo-erik/tornilleria' | '/orsy-Agro/agro' | '/orsy-Agro/orsy';
}
